...
**TAT-7** — нейросетевая архитектура с резонансной памятью для непрерывного обучения. Работает на CPU, в 20 раз меньше параметров, чем типичные CNN.
...
[![Subscribe](https://img.shields.io/badge/Подписаться-Следить%20за%20репозиторием-blue?style=for-the-badge&logo=github)](https://github.com/maratsultanov2/TAT-7/subscription)
